export const quizzes = [
    {
        question: "How much (in percent) is the PST and GST combined? (Note: this is also called HST (harmonized sale tax)",
        options: ["11%", "12%", "13%", "14%"],
        correctOption: "12%",
        rightPoints: 3,
        wrongPoints: -1
...

    {
        ...
        options: ["Toys", "Water", "Laptop", "Candy"],
        correctOption: "Water",
        rightPoints: 2,
        wrongPoints: -1
    },
...

    {
        ...
        link: "https://blog.cypruscu.com/teen-financial-toolkit-wants-vs.-needs",
        options: ["Food", "Shelter", "Water", "Pop"],
        correctOption: "Pop",
        rightPoints: 2,
        wrongPoints: -1
    },
    ...
    {
        question: "Which of the following is not exempt from PST?",
        link: "https://www2.gov.bc.ca/gov/content/taxes/sales-taxes/pst/exemptions",
        options: ["School supplies", "Unprocessed foods", "Toys", "Safety Equipment"],
        correctOption: "Toys",
        rightPoints: 3,
        wrongPoints: -1
    },
